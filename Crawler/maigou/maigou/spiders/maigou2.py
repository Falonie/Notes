...
class MaigouSpider(scrapy.Spider):
    name = 'maigou2'
    # start_urls = ['http://10.maigoo.com/list_7.html?C2464=2729&action=ajax&getac=brand&page={page}']
    # start_urls = ['http://10.maigoo.com/search/?catid=2991&C2464=2729&areaid=2754']
    # start_urls=['http://10.maigoo.com/search/?catid=2991&C2464=2729&areaid=3142']#江苏省
    # start_urls=['http://10.maigoo.com/search/?catid=2991&C2464=2729&areaid=3162']#安徽省
    # start_urls=['http://10.maigoo.com/search/?catid=2991&C2464=2729&areaid=3076']#河北省
    start_urls=['http://10.maigoo.com/search/?catid=2991&C2464=2729&areaid=3153&action=ajax&getac=brand&page={page}']#浙江省
